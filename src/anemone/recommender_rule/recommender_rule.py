...
from anemone.nodes.utils import is_winning
...
class AlmostEqualLogistic:
    ...
    def __call__(
        self, tree: trees.ValueTree, random_generator: random.Random
    ) -> BranchKey:
        """
        ...
        best_root_moves: list[BranchKey] = (
...
class SoftmaxRule:
    ...
    def __call__(
        ...
        best_move: BranchKey = move_as_list[0]
        return best_move
