...
from anemone.profiling.gui.components.layout import render_sidebar_context
from anemone.profiling.gui.components.selectors import render_base_dir_selector
from anemone.profiling.gui.state import consume_requested_page, ensure_session_defaults
...
def main() -> None:
    ...
    if (requested_page := consume_requested_page()) is not None:
        st.session_state["profiling_current_page"] = requested_page
    ...
    render_sidebar_context(base_dir=base_dir, current_page=current_page)
