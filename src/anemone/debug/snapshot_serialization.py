        ...
        "nodes": [
            {
                ...
                "depth": node.depth,
                "label": node.label,
                "player_label": node.player_label,
                "state_tag": node.state_tag,
                "direct_value": node.direct_value,
                "tree_value": node.tree_value,
                "effective_value": node.effective_value,
                "effective_value_source": node.effective_value_source,
...
def _node_from_json(data: dict[str, Any]) -> DebugNodeView:
    ...
    return DebugNodeView(
        ...
        player_label=_optional_str(data.get("player_label")),
        state_tag=_optional_str(data.get("state_tag")),
        direct_value=_optional_str(data.get("direct_value")),
        tree_value=_optional_str(data.get("tree_value", data.get("backed_up_value"))),
        effective_value=_optional_str(data.get("effective_value")),
        effective_value_source=_optional_str(data.get("effective_value_source")),
