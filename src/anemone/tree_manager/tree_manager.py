...
def _raise_if_branch_already_opened(
    *,
    ...
    existing_child = parent_node.branches_children.get(branch)
...
class TreeManager[
    ...
    def expand_instructions(
        ...
        opened_parent_nodes_by_id: dict[int, FamilyT] = {}
        ...
        for opening_instruction in opening_instructions.values():
            ...
            opened_parent_nodes_by_id[parent_node.id] = parent_node
        ...
        for parent_node in opened_parent_nodes_by_id.values():
